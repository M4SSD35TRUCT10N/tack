...
- Eine Suche über mehrere Seiten kann jetzt optional über `tack doc` selbst erzeugt werden: `[doc] allow_js_search = yes` generiert eine kleine JS-Suche als Progressive Enhancement.
...
- Cross-page search can now optionally be generated by `tack doc` itself: `[doc] allow_js_search = yes` emits a small JS search as progressive enhancement.
