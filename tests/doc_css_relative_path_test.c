...
int main(void) {
  ...
  ensure_dir_recursive("build/tests/doc-css-repo/src");
  ensure_dir_recursive("build/tests/doc-css-repo/docs/specs");
  ensure_dir_recursive("build/tests/doc-css-repo/docs/adr");
  ensure_dir_recursive("build/tests/doc-css-repo/templates");
  ensure_dir_recursive("build/tests/bin");

  if (write_text_file("build/tests/doc-css-repo/src/main.c",
      "int main(void) { return 0; }\n") != 0) {
    fprintf(stderr, "FAIL write-main\n");
    return 1;
  }
  if (write_text_file("build/tests/doc-css-repo/README.md",
      "# Root\n\nHello.\n") != 0) {
    fprintf(stderr, "FAIL write-readme\n");
    return 1;
  }
  if (write_text_file("build/tests/doc-css-repo/docs/specs/alpha.md",
      "# Alpha\n\nNested spec page.\n") != 0) {
    fprintf(stderr, "FAIL write-spec\n");
    return 1;
  }
  if (write_text_file("build/tests/doc-css-repo/docs/adr/beta.md",
      "# Beta\n\nNested adr page.\n") != 0) {
    fprintf(stderr, "FAIL write-adr\n");
    return 1;
  }
  if (write_text_file("build/tests/doc-css-repo/templates/tack_doc.css",
      "html,body{background:#111;color:#eee;} pre{color:inherit;}\n") != 0) {
    fprintf(stderr, "FAIL write-css\n");
    return 1;
  }

  path_join(repo_dir, sizeof(repo_dir), repo_root, "build/tests/doc-css-repo");
  path_join(tack_bin, sizeof(tack_bin), repo_root, "build/tests/bin/tack_doc_css");
  path_join(root_html, sizeof(root_html), repo_root, "build/tests/doc-css-repo/build/doc/readme.html");
  path_join(nested_html, sizeof(nested_html), repo_root, "build/tests/doc-css-repo/build/doc/docs/specs/alpha.html");
  path_join(nested_adr_html, sizeof(nested_adr_html), repo_root, "build/tests/doc-css-repo/build/doc/docs/adr/beta.html");
  ...
  if (run_argv_wait_const(cc_argv, 0) != 0) {
    fprintf(stderr, "FAIL build-tack-doc-css\n");
    return 1;
  }
  ...
  if (load_text_file(root_html, buf, sizeof(buf)) != 0) {
    fprintf(stderr, "FAIL read-root-html\n");
    return 1;
  }
  if (!contains_text(buf, "href=\"tack_doc.css\"")) {
    fprintf(stderr, "FAIL root-css-href\n");
    failures++;
  }
  ...
  if (!contains_text(buf, "href=\"../../tack_doc.css\"")) {
    fprintf(stderr, "FAIL nested-spec-css-href\n");
    failures++;
  }

  if (load_text_file(nested_adr_html, buf, sizeof(buf)) != 0) {
    fprintf(stderr, "FAIL read-nested-adr-html\n");
    return 1;
  }
  if (!contains_text(buf, "href=\"../../tack_doc.css\"")) {
    fprintf(stderr, "FAIL nested-adr-css-href\n");
    failures++;
  }
  ...
  puts("doc_css_relative_path_test: ok");
  return 0;
}
