...
### v0.7.9
- Bugfix: Rebuild-Entscheidung nutzt nicht mehr die reine Reihenfolge `depfile mtime > object mtime`; damit keine False-Positives nach Cache-Restores, bei denen Objekt und Depfile nacheinander geschrieben werden.
...
### v0.7.9
- Bugfix: rebuild decisions no longer rely on raw `depfile mtime > object mtime`; this avoids false stale detections after cache restore where object and depfile are written sequentially.
